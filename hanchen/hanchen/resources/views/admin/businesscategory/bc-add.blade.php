...
@section('content')
    <article class="page-container">
        ...
        @endif
        <form action="{{ url('admin/bc')}}" method="post" class="form form-horizontal" id="form-admin-role-add" enctype="multipart/form-data">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>点击时图标：</label>
                <div class="formControls col-xs-8 col-sm-9">
				<span class="btn-upload form-group">
				<input class="input-text upload-url" type="text" name="click" id="uploadfile" readonly placeholder="业务的点击图标" value="{{ old('click') }}" style="width:200px">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
				<span class="btn-upload form-group">
				<input class="input-text upload-url" type="text" name="unclick" id="uploadfile" readonly placeholder="业务的点击图标" value="{{  old('unclick ')  }}" style="width:200px">
				<a href="javascript:void();" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 浏览文件</a>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" name="name" id="" placeholder="显示在主界面信息" value="{{   old('name ')  }}" class="input-text">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>分类英文名：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" name="enname" id="" placeholder="显示在主界面信息" value="{{  old('enname ')  }}" class="input-text">
                </div>
            </div>
            <div class="row cl">
