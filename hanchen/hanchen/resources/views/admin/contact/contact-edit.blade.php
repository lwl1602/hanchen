...
@section('content')
	...
	<form action="{{ url('admin/contact/edit')}}" method="post" class="form form-horizontal" id="form-admin-role-add" enctype="multipart/form-data">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="name" id="" placeholder="公司名称" value="{{ $contact->contact_name }}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>地     址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="site" id="" placeholder="地      址" name="site" value="{{ $contact->contact_site }}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>邮政编码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="postcode" id="" placeholder="邮政编码" value="{{ $contact->contact_postcode }}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>电       话：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="phone" id="" placeholder="电       话" name="phone" value="{{ $contact->contact_phone }}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>传       真：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="faxes" id="" placeholder="传       真" value="{{ $contact->contact_faxes }}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>电子信箱：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="email" id="" placeholder="电子信箱" value="{{ $contact->contact_email }}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>网       址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="url" id="" placeholder="网       址" value="{{ $contact->contact_url }}" class="input-text">
			</div>
		</div>
		<div class="row cl">
