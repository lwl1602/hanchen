	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					<td>00{{ $i+1 }}</td>
					<td><img width="600" height="200" src="{{ asset($pictures[$i]->img_path) }}"></td>
					<td class="td-status">{{ $pictures[$i]->img_intro }}</td>
				...
				{!! $pictures->render(new \App\Http\Controllers\Common\BoolawuiThreePresenter($pictures)) !!}
	</div>
